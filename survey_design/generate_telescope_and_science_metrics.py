...
mag_max_eval_range = {'Bright': [[19, 21]],
                      ...
                      'Dark'  : [[23, 24.5], [24.2, 26], [24.2, 26], [24.2, 26]]}
...
multi_mag_bin_approach = {'Bright': [False],
                          ...
                          'Dark'  : [False, True, True, True]}

config_surveys = [config_survey_bright, config_survey_grey, config_survey_dark]
...
for i, config_survey in enumerate(config_surveys):
    ...
    total_Informations = _survey_design_science_metrics.build_total_survey_information_metrics(config_survey_update, per_tracer_forecasts)
