...
get_XMMLSS_CLAUDS_HSC_SExtractor_Lephare = 'curl -O -L "https://ws.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/files/vault/clauds/desprez/PublicRelease/XMMLSS-SExtractor-Lephare.fits"'
get_XMMLSS_CLAUDS_HSC_HSCPipe_Phosphoros = 'curl -O -L "https://ws.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/files/vault/clauds/desprez/PublicRelease/XMMLSS-HSCpipe-Phosphoros.fits"'


#####
get_COSMOS_CLAUDS_HSC_SExtractor_Lephare = 'curl -O -L "https://ws.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/files/vault/clauds/desprez/PublicRelease/COSMOS-SExtractor-Lephare.fits"'
get_COSMOS_CLAUDS_HSC_HSCPipe_Phosphoros = 'curl -O -L "https://ws.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/files/vault/clauds/desprez/PublicRelease/COSMOS-HSCpipe-Phosphoros.fits"'
