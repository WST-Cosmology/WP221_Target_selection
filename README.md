...
Authors: WST Cosmology Work Package 2.2.1 "Target Selection and Survey Design" (William d'Assigines Doumerg, Aurélien Verdier, Antoine Rocher, Behnood Bandi, Constantin Payerne).
...
- [pycorr](https://github.com/cosmodesi/pycorr)